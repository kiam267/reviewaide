  ...
  return (
    <React.Fragment>
      ...
      <Offcanvas
        ...
        toggle={toggleCanvas}
        direction={
          html.hasAttribute('dir') ? 'start' : 'end'
        }
